...
| ----------------------- | --------------------------------------------------------------------------- | ------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 🗓 Open Day (开幕)      | 1月28日 19:00-20:30                                                         | 📍 Zoom <br> 📍 Twitter 直播</nobr>                                          | [Zoom 链接](https://us06web.zoom.us/j/82510601772?pwd=2MtYQkfkFOIUsz98wb4lrzcdMQO1iB.1) <br> [X 直播链接](https://x.com/i/broadcasts/1yoJMPZZkkOGQ) |
| 💻 Co-building (开发期) | 1月29日 19:00-20:00  <br> 1月30日 14:00-15:00  <br> 1月31日 18:30-19:30 | *Hacking Time!* | [Zoom 链接](https://us06web.zoom.us/j/84019245134?pwd=IgtZadqIZLuzHtPCgNphzcSbu8nigS.1)  <br> [Zoom 链接](https://us06web.zoom.us/j/88224933555?pwd=qraz4AfI4Xb86JDyTjWviab2bKuBpm.1)  <br> [Zoom 链接](https://us06web.zoom.us/j/82971130369?pwd=ii6CAY79mibBunwAz3lIw4ar8Kx37m.1) |
| 🛠 Tech Workshop        | 1月29日 20:30-22:00                                                         | 📍 Zoom <br> 📍 Twitter 直播</nobr>                                          | [Zoom 链接](https://us06web.zoom.us/j/84292630277?pwd=I2hqeQAvFnOCXaAKY1tLxmd9aeWR1a.1) <br> [X 直播链接](https://x.com/i/broadcasts/1YqKDNokRPeJV) |
...
| 🏁 Demo Day (路演)      | 2月1日 19:00-22:00                                                          | 📍 Zoom <br> 📍 Twitter 直播</nobr>                                          | [Zoom 链接](https://us06web.zoom.us/j/86782028304?pwd=wfBDRXFhKM5R9ijUMN2QLWXwk6wTxq.1) <br> [X 直播链接](https://x.com/i/broadcasts/1vOGwdMrvVrJB) |
...
报名人数：169｜已提交项目数量：52（名单详见 `CONTRIBUTING.md`）
...
DataDance SDK通过ERC-7962底层能力相当于在链上提供了一层“对外不可识别的收款接口”，既能结算、能对账、能审计，但不会暴露客户关系和商业结构。
ERC-7962 作为一种基于一次性公钥的隐私接收标准，可广泛应用于 Web3 与 Web2 数字资产融合场景。在交易所与托管机构中，平台可为用户提供隐私化的充值与资产归集路径，避免链上资产与实名账户直接绑定，降低地址复用带来的安全与合规风险。

使用DataDance SDK可以应用于以下常用场景：
1. 在PayFi 与稳定币支付领域，企业可使用 DataDance SDK 接收工资、服务费、跨境结算与 B2B 付款，防止合作方通过链上分析反推出收入规模、客户结构或商业关系。
2. 在NFT 与数字内容行业，艺术家、IP 方及平台可通过一次性公钥接收 NFT 转移、版权分成与授权费用，避免资产持仓和收入来源被链上画像系统持续追踪。
3. 对于Web2 数据公司与版权机构，DataDance SDK 可作为链上结算与授权收费的隐私接收层，用于数据授权费、API 调用费、内容分发收益的结算，在不暴露客户名单与商业定价的前提下实现透明可验证的链上清结算。
4. 在DAO 与 Web3 组织中，该标准可用于匿名捐赠、赏金支付、资助发放与 Treasury 收款，在保持组织治理公开性的同时降低成员身份与资产关联暴露。
5. 在链游与虚拟资产经济中，高价值道具、装备与收益可通过隐私接收方式分发，防止玩家资产被精准追踪，提升用户安全感与长期留存。

通过覆盖支付、内容、数据、版权与组织协作等多个方向，DataDance SDK为以太坊提供了一种兼顾隐私、安全与商业可落地性的资产接收基础能力。
...
- Zoom 链接：https://us06web.zoom.us/j/86782028304?pwd=wfBDRXFhKM5R9ijUMN2QLWXwk6wTxq.1
...
| <img src="./materials/images/Ray.jpg" width="50"><br>**Ray**<br>[@rayoo_eth](https://twitter.com/rayoo_eth) | 1月30日 | AMA 嘉宾 | LXDAO 核心贡献者,LXDAO 的早期成员主要研究以太坊和公共物品 |
| <img src="./materials/images/Coooder.jpeg" width="50"><br>**Coooder**<br>[@Coooder_Crypto](https://x.com/Coooder_Crypto) | 1月30日 | AMA 嘉宾 | LXDAO Builder， [@BUPT3DAO](https://twitter.com/BUPT3DAO) |
...
| <img src="./materials/images/Wachi.jpeg" width="50"><br>**Wachi**<br>[@0xwachi_](https://twitter.com/0xwachi_) | 2月1日 | 技术评委 | LXDAO Builder |
